...
$id = intval($_GET['departamento_id']);
?>
...
<head>
<meta charset="UTF-8">
<title>Herramientas por Departamento</title>
<style>
...
<h2>Herramientas por departamento</h2>
...
<?php
$q="SELECT e.nombre, h.nombre as herramienta, a.fecha_asignacion, a.comentarios
FROM asignaciones a
JOIN empleados e ON a.empleado_id=e.id_empleado
JOIN herramientas h ON a.herramienta_id=h.id_herramienta
WHERE e.departamento_id='$id' AND a.activa=1";
